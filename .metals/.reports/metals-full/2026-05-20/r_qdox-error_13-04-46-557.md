error id: file://<WORKSPACE>/riskified-sdk/src/main/java/com/riskified/models/PlaidScores.java
file://<WORKSPACE>/riskified-sdk/src/main/java/com/riskified/models/PlaidScores.java
...
```java
offset: 0
uri: file://<WORKSPACE>/riskified-sdk/src/main/java/com/riskified/models/PlaidScores.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/riskified-sdk/src/main/java/com/riskified/models/PlaidScores.java