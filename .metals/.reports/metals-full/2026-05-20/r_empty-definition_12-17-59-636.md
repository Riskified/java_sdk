error id: file://<WORKSPACE>/riskified-sdk/src/main/java/com/riskified/models/PaypalPaymentDetails.java:_empty_/IPaymentDetails#
file://<WORKSPACE>/riskified-sdk/src/main/java/com/riskified/models/PaypalPaymentDetails.java
empty definition using pc, found symbol in pc: _empty_/IPaymentDetails#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 122
uri: file://<WORKSPACE>/riskified-sdk/src/main/java/com/riskified/models/PaypalPaymentDetails.java
text:
```scala
...
public class PaypalPaymentDetails implements IPaymentD@@etails {
