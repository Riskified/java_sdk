	...
	public void run() {
	  ...
	  String hash = null;		
		...
		if (httpMethod.equals("POST")) {
            ...
            NotificationFormmater formatter = new NotificationFormmater("123");
            NotificationOrder notification = formatter.toObject(body, hash).order;
			
			sendResponse(200, "<HTML><BODY>Merchant Received Notification For Order" + notification.id + "with status" + notification.status +  "and description " + notification.description + "</BODY></HTML>");
